                            ...
                            <div class="db-nav">
                                ...
                                <div class="db-nav-list">
                                    ...
                                    <ul class="nav nav-tabs profiletabs" role="tablist">
                                        ...
                                        <li><a class="nav-link border-0" id="aboutme" data-bs-toggle="tab" href="#aboutmetab"><span class="material-symbols-outlined">person</span>&nbsp;&nbsp;About <?php if($rowformfill['gender'] == 'Male') { echo "Groom"; }  if($rowformfill['gender'] == 'Female') { echo "Bride"; } ?> <?php if($rowformfill['aboutme'] == 'Done') { ?><i class="fa fa-check-circle text-success formfill"></i> <?php }  else { ?><i class="fa fa-times-circle text-danger formfill"></i><?php } ?></a></li>
                                        ...
                                        <li><a class="nav-link border-0" id="groom" data-bs-toggle="tab" href="#groomtab"><?php if($rowformfill['gender'] == 'Male') { echo "<span class='material-symbols-outlined'>man</span>&nbsp;&nbsp;Groom"; } if($rowformfill['gender'] == 'Female') { echo "<span class='material-symbols-outlined'>woman</span>&nbsp;&nbsp;Bride"; } ?> Location <?php if($rowformfill['groomlocation'] == 'Done') { ?><i class="fa fa-check-circle text-success formfill"></i> <?php } if($rowformfill['bridelocation'] == 'Done') { ?><i class="fa fa-check-circle text-success formfill"></i> <?php } if($rowformfill['bridelocation'] == '' && $rowformfill['groomlocation'] == '') { ?><i class="fa fa-times-circle text-danger formfill"></i> <?php } ?></a></li>
                                                        ...
                                                        <div class="edit-pro-parti">
                                                            ...
                                                            <div class="row p-4">
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <span class="iconbox">
                                                                        <select class="form-select chosen-select" name="createby" required disabled>
                                                                            <option value="">Select</option>
                                                                            <option <?php if($rowbasicinfo['createby'] == 'Self') { echo "selected"; }?>>Self</option>
                                                                            <option <?php if($rowbasicinfo['createby'] == 'Son') { echo "selected"; }?>>Son</option>
                                                                            <option <?php if($rowbasicinfo['createby'] == 'Daughter') { echo "selected"; }?>>Daughter</option>
                                                                            <option <?php if($rowbasicinfo['createby'] == 'Brother') { echo "selected"; }?>>Brother</option>
                                                                            <option <?php if($rowbasicinfo['createby'] == 'Sister') { echo "selected"; }?>>Sister</option>
                                                                            <option <?php if($rowbasicinfo['createby'] == 'Friends') { echo "selected"; }?>>Friends</option>
                                                                            <option <?php if($rowbasicinfo['createby'] == 'Relative') { echo "selected"; }?>>Relative</option>
                                                                            <option <?php if($rowbasicinfo['createby'] == 'Others') { echo "selected"; }?>>Others</option>
                                                                      </select>
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <span class="iconbox">
                                                                        <input type="text" pseudo="placeholder" class="form-control leftspace" placeholder="Enter Details" value="<?php echo $rowbasicinfo['fullname']; ?>" name="fullname"  required readonly>
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <span class="iconbox">
                                                                        <select class="form-select chosen-select" name="gender"  required disabled>
                                                                            <option value="">Select</option>
                                                                            <option <?php if($rowbasicinfo['gender'] == 'Male') { echo "selected"; }?>>Male</option>
                                                                            <option <?php if($rowbasicinfo['gender'] == 'Female') { echo "selected"; }?>>Female</option>
                                                                            <option <?php if($rowbasicinfo['gender'] == 'Other') { echo "selected"; }?>>Other</option>
                                                                      </select>
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <select class="form-select chosen-select" id="marital" name="marital" required>
                                                                        <option value="">Select</option>
                                                                        <option <?php if($rowbasicinfo['marital'] == 'Never Married') { echo "selected"; }?>>Never Married</option>
                                                                        <option <?php if($rowbasicinfo['marital'] == 'Divorced') { echo "selected"; }?>>Divorced</option>
                                                                        <option <?php if($rowbasicinfo['marital'] == 'Widowed') { echo "selected"; }?>>Widowed</option>
                                                                        <option <?php if($rowbasicinfo['marital'] == 'Awaiting Divorce') { echo "selected"; }?>>Awaiting Divorce</option>
                                                                  </select>
                                                                ...
                                                                <div class="col-md-6 form-group" id="children" <?php if($rowbasicinfo['children'] == '') { ?> style="display:none" <?php } else { ?> style="display:block" <?php } ?>>
                                                                    ...
                                                                    <select class="form-select chosen-select" id="childrenselect" name="children">
                                                                        <option value="">Select</option>
                                                                        <option <?php if($rowbasicinfo['children'] == 'Yes') { echo "selected"; }?>>Yes</option>
                                                                        <option <?php if($rowbasicinfo['children'] == 'No') { echo "selected"; }?>>No</option>
                                                                  </select>
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <select class="form-select chosen-select" id="height" name="height" required>
                                                                        <option value="">Select</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '4 Feet 5 Inches') { echo "selected"; }?>>4 Feet 5 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '4 Feet 6 Inches') { echo "selected"; }?>>4 Feet 6 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '4 Feet 7 Inches') { echo "selected"; }?>>4 Feet 7 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '4 Feet 8 Inches') { echo "selected"; }?>>4 Feet 8 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '4 Feet 9 Inches') { echo "selected"; }?>>4 Feet 9 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '4 Feet 10 Inches') { echo "selected"; }?>>4 Feet 10 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '4 Feet 11 Inches') { echo "selected"; }?>>4 Feet 11 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '5 Feet 0 Inches') { echo "selected"; }?>>5 Feet 0 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '5 Feet 1 Inches') { echo "selected"; }?>>5 Feet 1 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '5 Feet 2 Inches') { echo "selected"; }?>>5 Feet 2 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '5 Feet 3 Inches') { echo "selected"; }?>>5 Feet 3 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '5 Feet 4 Inches') { echo "selected"; }?>>5 Feet 4 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '5 Feet 5 Inches') { echo "selected"; }?>>5 Feet 5 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '5 Feet 6 Inches') { echo "selected"; }?>>5 Feet 6 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '5 Feet 7 Inches') { echo "selected"; }?>>5 Feet 7 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '5 Feet 8 Inches') { echo "selected"; }?>>5 Feet 8 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '5 Feet 9 Inches') { echo "selected"; }?>>5 Feet 9 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '5 Feet 10 Inches') { echo "selected"; }?>>5 Feet 10 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '5 Feet 11 Inches') { echo "selected"; }?>>5 Feet 11 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '6 Feet 0 Inches') { echo "selected"; }?>>6 Feet 0 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '6 Feet 1 Inches') { echo "selected"; }?>>6 Feet 1 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '6 Feet 2 Inches') { echo "selected"; }?>>6 Feet 2 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '6 Feet 3 Inches') { echo "selected"; }?>>6 Feet 3 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '6 Feet 4 Inches') { echo "selected"; }?>>6 Feet 4 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '6 Feet 5 Inches') { echo "selected"; }?>>6 Feet 5 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '6 Feet 6 Inches') { echo "selected"; }?>>6 Feet 6 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '6 Feet 7 Inches') { echo "selected"; }?>>6 Feet 7 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '6 Feet 8 Inches') { echo "selected"; }?>>6 Feet 8 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '6 Feet 9 Inches') { echo "selected"; }?>>6 Feet 9 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '6 Feet 10 Inches') { echo "selected"; }?>>6 Feet 10 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '6 Feet 11 Inches') { echo "selected"; }?>>6 Feet 11 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '7 Feet 0 Inches') { echo "selected"; }?>>7 Feet 0 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '7 Feet 1 Inches') { echo "selected"; }?>>7 Feet 1 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '7 Feet 2 Inches') { echo "selected"; }?>>7 Feet 2 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '7 Feet 3 Inches') { echo "selected"; }?>>7 Feet 3 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '7 Feet 4 Inches') { echo "selected"; }?>>7 Feet 4 Inches</option>
                                                                        <option <?php if($rowbasicinfo['height'] == '7 Feet 5 Inches') { echo "selected"; }?>>7 Feet 5 Inches</option>
                                                                  </select>
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <select class="form-select chosen-select" id="noweight" name="weight">
                                                                        ...
                                                                        {
                                                                        ?>
                                                                        <option <?php if($rowbasicinfo['weight'] == $w.' Kg') { echo "selected"; }?>><?php echo $w; ?> Kg</option>
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                  </select>
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <select class="form-select chosen-select" id="nophysical" name="physical" >
                                                                        <option value="">Select</option>
                                                                        <option <?php if($rowbasicinfo['physical'] == 'Normal') { echo "selected"; }?>>Normal</option>
                                                                        <option <?php if($rowbasicinfo['physical'] == 'Handicapped by birth') { echo "selected"; }?>>Handicapped by birth</option>
                                                                        <option <?php if($rowbasicinfo['physical'] == 'Handicapped by war') { echo "selected"; }?>>Handicapped by war</option>
                                                                  </select>
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <select class="form-select chosen-select" id="langauge" name="langauge[]" multiple required>
                                                                        <option value="">Select</option>
                                                                        <option <?php if(in_array("Hindi", $lang)) { echo "selected"; }?>>Hindi</option>
                                                                        <option <?php if(in_array("Marathi", $lang)) { echo "selected"; }?>>Marathi</option>
                                                                        <option <?php if(in_array("Punjabi", $lang)) { echo "selected"; }?>>Punjabi</option>
                                                                        <option <?php if(in_array("Bengali", $lang)) { echo "selected"; }?>>Bengali</option>
                                                                        <option <?php if(in_array("Gujarati", $lang)) { echo "selected"; }?>>Gujarati</option>
                                                                        <option <?php if(in_array("Urdu", $lang)) { echo "selected"; }?>>Urdu</option>
                                                                        <option <?php if(in_array("Telugu", $lang)) { echo "selected"; }?>>Telugu</option>
                                                                        <option <?php if(in_array("Kannada", $lang)) { echo "selected"; }?>>Kannada</option>
                                                                        <option <?php if(in_array("English", $lang)) { echo "selected"; }?>>English</option>
                                                                        <option <?php if(in_array("Tamil", $lang)) { echo "selected"; }?>>Tamil</option>
                                                                        <option <?php if(in_array("Odia", $lang)) { echo "selected"; }?>>Odia</option>
                                                                        <option <?php if(in_array("Marwari", $lang)) { echo "selected"; }?>>Marwari</option>
                                                                        <option <?php if(in_array("Arabic", $lang)) { echo "selected"; }?>>Arabic</option>
                                                                        <option <?php if(in_array("Arunachali", $lang)) { echo "selected"; }?>>Arunachali</option>
                                                                        <option <?php if(in_array("Assamese", $lang)) { echo "selected"; }?>>Assamese</option>
                                                                        <option <?php if(in_array("Awadhi", $lang)) { echo "selected"; }?>>Awadhi</option>
                                                                        <option <?php if(in_array("Baluchi", $lang)) { echo "selected"; }?>>Baluchi</option>
                                                                        <option <?php if(in_array("Bhojpuri", $lang)) { echo "selected"; }?>>Bhojpuri</option>
                                                                        <option <?php if(in_array("Bhutia", $lang)) { echo "selected"; }?>>Bhutia</option>
                                                                        <option <?php if(in_array("Brahui", $lang)) { echo "selected"; }?>>Brahui</option>
                                                                        <option <?php if(in_array("Brij", $lang)) { echo "selected"; }?>>Brij</option>
                                                                        <option <?php if(in_array("Burmese", $lang)) { echo "selected"; }?>>Burmese</option>
                                                                        <option <?php if(in_array("Chattisgarhi", $lang)) { echo "selected"; }?>>Chattisgarhi</option>
                                                                        <option <?php if(in_array("Coorgi", $lang)) { echo "selected"; }?>>Coorgi</option>
                                                                        <option <?php if(in_array("Dogri", $lang)) { echo "selected"; }?>>Dogri</option>
                                                                        <option <?php if(in_array("French", $lang)) { echo "selected"; }?>>French</option>
                                                                        <option <?php if(in_array("Garhwali", $lang)) { echo "selected"; }?>>Garhwali</option>
                                                                        <option <?php if(in_array("Garo", $lang)) { echo "selected"; }?>>Garo</option>
                                                                        <option <?php if(in_array("Haryanavi", $lang)) { echo "selected"; }?>>Haryanavi</option>
                                                                        <option <?php if(in_array("Himachali/Pahari", $lang)) { echo "selected"; }?>>Himachali/Pahari</option>
                                                                        <option <?php if(in_array("Hindko", $lang)) { echo "selected"; }?>>Hindko</option>
                                                                        <option <?php if(in_array("Kakbarak", $lang)) { echo "selected"; }?>>Kakbarak</option>
                                                                        <option <?php if(in_array("Kanauji", $lang)) { echo "selected"; }?>>Kanauji</option>
                                                                        <option <?php if(in_array("Kashmiri", $lang)) { echo "selected"; }?>>Kashmiri</option>
                                                                        <option <?php if(in_array("Khandesi", $lang)) { echo "selected"; }?>>Khandesi</option>
                                                                        <option <?php if(in_array("Khasi", $lang)) { echo "selected"; }?>>Khasi</option>
                                                                        <option <?php if(in_array("Konkani", $lang)) { echo "selected"; }?>>Konkani</option>
                                                                        <option <?php if(in_array("Koshali", $lang)) { echo "selected"; }?>>Koshali</option>
                                                                        <option <?php if(in_array("Kumaoni", $lang)) { echo "selected"; }?>>Kumaoni</option>
                                                                        <option <?php if(in_array("Kutchi", $lang)) { echo "selected"; }?>>Kutchi</option>
                                                                        <option <?php if(in_array("Ladakhi", $lang)) { echo "selected"; }?>>Ladakhi</option>
                                                                        <option <?php if(in_array("Lepcha", $lang)) { echo "selected"; }?>>Lepcha</option>
                                                                        <option <?php if(in_array("Magahi", $lang)) { echo "selected"; }?>>Magahi</option>
                                                                        <option <?php if(in_array("Maithili", $lang)) { echo "selected"; }?>>Maithili</option>
                                                                        <option <?php if(in_array("Malay", $lang)) { echo "selected"; }?>>Malay</option>
                                                                        <option <?php if(in_array("Malayalam", $lang)) { echo "selected"; }?>>Malayalam</option>
                                                                        <option <?php if(in_array("Manipuri", $lang)) { echo "selected"; }?>>Manipuri</option>
                                                                        <option <?php if(in_array("Miji", $lang)) { echo "selected"; }?>>Miji</option>
                                                                        <option <?php if(in_array("Mizo", $lang)) { echo "selected"; }?>>Mizo</option>
                                                                        <option <?php if(in_array("Monpa", $lang)) { echo "selected"; }?>>Monpa</option>
                                                                        <option <?php if(in_array("Nepali", $lang)) { echo "selected"; }?>>Nepali</option>
                                                                        <option <?php if(in_array("Pashto", $lang)) { echo "selected"; }?>>Pashto</option>
                                                                        <option <?php if(in_array("Persian", $lang)) { echo "selected"; }?>>Persian</option>
                                                                        <option <?php if(in_array("Rajasthani", $lang)) { echo "selected"; }?>>Rajasthani</option>
                                                                        <option <?php if(in_array("Sanskrit", $lang)) { echo "selected"; }?>>Sanskrit</option>
                                                                        <option <?php if(in_array("Santhali", $lang)) { echo "selected"; }?>>Santhali</option>
                                                                        <option <?php if(in_array("Seraiki", $lang)) { echo "selected"; }?>>Seraiki</option>
                                                                        <option <?php if(in_array("Sindhi", $lang)) { echo "selected"; }?>>Sindhi</option>
                                                                        <option <?php if(in_array("Sinhala", $lang)) { echo "selected"; }?>>Sinhala</option>
                                                                        <option <?php if(in_array("Sourashtra", $lang)) { echo "selected"; }?>>Sourashtra</option>
                                                                        <option <?php if(in_array("Tagalog", $lang)) { echo "selected"; }?>>Tagalog</option>
                                                                        <option <?php if(in_array("Tulu", $lang)) { echo "selected"; }?>>Tulu</option>
                                                                        <option <?php if(in_array("Others", $lang)) { echo "selected"; }?>>Others</option>
                                                                  </select>
                                            ...
                                            <div id="aboutmetab" class=" tab-pane fade p-0">
                                                <div class="form-login"  >
                                                    <form action="profile-aboutme.php" method="post">
                                                        ...
                                                        <div class="edit-pro-parti">
                                                            <div class="form-tit p-3 tophead">
                                                                <h1 class="text-white">About <?php if($rowformfill['groomlocation'] == 'Done') { echo "Groom"; } if($rowformfill['bridelocation'] == 'Done') { echo "Bride"; } ?>, Partner and Family </h1>
                                                                <p class="m-0 text-white">'<span class="text-info">*</span>' Required  fields</p>
                                                                <a href="user-profile.php" class="sett-edit-btn sett-acc-edit-eve"><i class="fa fa-eye" aria-hidden="true"></i> View</a>
                                                            </div>
                                                            <?php
                                                            if($_GET['aboutme_update'] == 'yes')
                                                            {
                                                            ?>
                                                                <p class="text-center text-success" id="invalidpop"><b>Your profile has been successfully updated</b></p>
                                                            <?php
                                                            ...
                                                            { 
                                                            ?>
                                                                <p class="text-center text-danger m-0 blinking-text"><b>Under review and will be live shortly</b></p>
                                                            <?php 
                                                            } 
                                                            ?>
                                                            <div class="row p-4">
                                                                ...
                                                                <div class="col-md-12 form-group">
                                                                    <label class="lb"><i class="fa fa-times-circle text-danger" id="fewwordscross" style="display:none"></i> Share Few Words <span class="text-danger">*</span></label>
                                                                    <span class="iconbox">
                                                                        <textarea type="text" class="form-control leftspace" placeholder="Enter Details" id="aboutmecontent" name="aboutme" required <?php if($rowformfill['profilestatus'] == '0') { echo "disabled"; } ?>><?php echo $rowbasicinfo['aboutme']; ?></textarea>
                                                                    <span class="material-symbols-outlined icon">edit</span>
                                                                    </span>
                                                                    <p class="text-white mt-4 notebox"><b>Note:</b> This section will be reviewed each time you update it. Please allow up to 24 hours for it to go live.</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--END PROFILE BIO-->
                                                        <?php 
                                                        if($rowformfill['profilestatus'] == '1') 
                                                        { 
                                                        ?>
                                                        <button type="submit" id="aboutupdatebtn" class="btn btn-primary profile-btn">Update</button>
                                                        <?php
                                                        }
                                                        ?>
                                                    </form>
                                                            ...
                                                            <div class="row p-4">
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <select class="form-select chosen-select" id="dosh" name="manglik" required>
                                                                        <option value="">Select</option>
                                                                        <option <?php if($rowastroinfo['manglik'] == 'Yes') { echo "selected"; } ?>>Yes</option>
                                                                        <option <?php if($rowastroinfo['manglik'] == 'No') { echo "selected"; } ?>>No</option>
                                                                        <option <?php if($rowastroinfo['manglik'] == 'Dont Know') { echo "selected"; } ?>>Dont Know</option>
                                                                  </select>
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <span class="iconbox">
                                                                        <select class="form-select chosen-select" id="religion" name="religion" required>
                                                                            ...
                                                                            {
                                                                            ?>
                                                                            <option <?php if($rowreligiousinfo['religion'] == $rowreligion['religion']) { echo "selected"; } ?> value="<?php echo $rowreligion['religion']; ?>"><?php echo $rowreligion['religion']; ?></option>
                                                                            <?php
                                                                            }
                                                                            ?>
                                                                        </select>
                                                                ...
                                                                <div class="col-md-6 form-group signupcaste" id="<?php echo str_replace(" ", "-", $religion)?>" <?php if($rowreligiousinfo['religion'] == str_replace(" ", "-", $religion)) { ?>style="display:block"<?php } else { ?>style="display:none"<?php } ?>>
                                                                    ...
                                                                    <span class="iconbox">
                                                                        <select class="form-select chosen-select castedd" id="<?php echo str_replace(" ", "-", $religion).'_dd'?>" >
                                                                            ...
                                                                            {
                                                                            ?>
                                                                                <option <?php if($rowreligiousinfo['caste'] == $rowcaste['caste']) { echo "selected"; } ?> value="<?php echo $rowcaste['caste']; ?>"><?php echo $rowcaste['caste']; ?></option>
                                                                            <?php
                                                                            }
                                                                            ?>
                                                                        </select>
                                                            ...
                                                            <div class="row p-4">
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <select class="form-select chosen-select" id="stream" name="stream" required>
                                                                        ...
                                                                        {
                                                                        ?>
                                                                        <option <?php if($roweudcationinfo['stream'] == str_replace("/", "_", str_replace(" ", "-", $rowstream['stream']))) { echo "selected"; } ?> value="<?php echo str_replace("/", "_", str_replace(" ", "-", $rowstream['stream'])); ?>"><?php echo $rowstream['stream']; ?></option>
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                  </select>
                                                                ...
                                                                <div class="col-md-6 form-group signupstream" id="<?php echo str_replace("/", "_", str_replace(" ", "-", $stream)); ?>" <?php if($roweudcationinfo['stream'] == str_replace("/", "_", str_replace(" ", "-", $stream))) { ?>style="display:block"<?php } else { ?>style="display:none"<?php } ?>>
                                                                    ...
                                                                    <span class="iconbox">
                                                                        <select class="form-select chosen-select educationdd" id="<?php echo str_replace("/", "_", str_replace(" ", "-", $stream)).'_dd'?>">
                                                                            ...
                                                                            {
                                                                            ?>
                                                                                <option <?php if($roweudcationinfo['education'] == $roweducation['education']) { echo "selected"; } ?>  value="<?php echo $roweducation['education']; ?>"><?php echo $roweducation['education']; ?></option>
                                                                            <?php
                                                                            }
                                                                            ?>
                                                                        </select>
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <select class="form-select chosen-select" id="domain" name="profession" required>
                                                                        ...
                                                                        {
                                                                        ?>
                                                                        <option <?php if($roweudcationinfo['profession'] == str_replace("&", "and", str_replace(",", "", str_replace(" ", "-", $rowdomain['domain'])))) { echo "selected"; } ?> value="<?php echo str_replace("&", "and", str_replace(",", "", str_replace(" ", "-", $rowdomain['domain']))); ?>"><?php echo $rowdomain['domain']; ?></option>
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                  </select>
                                                                ...
                                                                <div class="col-md-6 form-group signupdomain" id="<?php echo "desig_".str_replace("&", "and", str_replace(",", "", str_replace(" ", "-", $domain))); ?>"  <?php if($roweudcationinfo['profession'] == str_replace("&", "and", str_replace(",", "", str_replace(" ", "-", $domain)))) { ?>style="display:block"<?php } else { ?>style="display:none"<?php } ?>>
                                                                    ...
                                                                    <span class="iconbox">
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            {
                                                                            ?>
                                                                                <option <?php if($roweudcationinfo['designation'] == $rowdesignation['designation']) { echo "selected"; } ?> value="<?php echo $rowdesignation['designation']; ?>"><?php echo $rowdesignation['designation']; ?></option>
                                                                            <?php
                                                                            }
                                                                            ?>
                                                                        </select>
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <select class="form-select chosen-select" name="income" id="income" required>
                                                                        <option value="">Select</option>
                                                                        <option <?php if($roweudcationinfo['income'] == 'Upto 1 Lakhs') { echo "selected"; } ?>>Upto 1 Lakhs</option>
                                                                        <option <?php if($roweudcationinfo['income'] == '1 Lakhs - 2 Lakhs') { echo "selected"; } ?>>1 Lakhs - 2 Lakhs</option>
                                                                        <option <?php if($roweudcationinfo['income'] == '2 Lakhs - 5 Lakhs') { echo "selected"; } ?>>2 Lakhs - 5 Lakhs</option>
                                                                        <option <?php if($roweudcationinfo['income'] == '5 Lakhs - 7 Lakhs') { echo "selected"; } ?>>5 Lakhs - 7 Lakhs</option>
                                                                        <option <?php if($roweudcationinfo['income'] == '7 Lakhs - 10 Lakhs') { echo "selected"; } ?>>7 Lakhs - 10 Lakhs</option>
                                                                        <option <?php if($roweudcationinfo['income'] == '10 Lakhs - 15 Lakhs') { echo "selected"; } ?>>10 Lakhs - 15 Lakhs</option>
                                                                        <option <?php if($roweudcationinfo['income'] == '15 Lakhs - 20 Lakhs') { echo "selected"; } ?>>15 Lakhs - 20 Lakhs</option>
                                                                        <option <?php if($roweudcationinfo['income'] == '20 Lakhs - 25 Lakhs') { echo "selected"; } ?>>20 Lakhs - 25 Lakhs</option>
                                                                        <option <?php if($roweudcationinfo['income'] == '25 Lakhs - 30 Lakhs') { echo "selected"; } ?>>25 Lakhs - 30 Lakhs</option>
                                                                        <option <?php if($roweudcationinfo['income'] == '30 Lakhs - 50 Lakhs') { echo "selected"; } ?>>30 Lakhs - 50 Lakhs</option>
                                                                        <option <?php if($roweudcationinfo['income'] == '50 Lakhs - 75 Lakhs') { echo "selected"; } ?>>50 Lakhs - 75 Lakhs</option>
                                                                        <option <?php if($roweudcationinfo['income'] == '75 Lakhs - 1 Crore') { echo "selected"; } ?>>75 Lakhs - 1 Crore</option>
                                                                        <option <?php if($roweudcationinfo['income'] == '1 Crore and Above') { echo "selected"; } ?>>1 Crore and Above</option>
                                                                  </select>
                                                            ...
                                                            <div class="row p-4">
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <select class="form-select chosen-select" name="country" id="groomcountry" required>
                                                                        ...
                                                                        {
                                                                        ?>
                                                                        <option <?php if($rowcountry['country'] == $rowgroomlocation['country']) { echo "selected"; } ?>><?php echo $rowcountry['country']; ?></option>
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                  </select>
                                                                ...
                                                                <div class="col-md-6 form-group" id="groomcitizen">
                                                                    ...
                                                                    <select class="form-select chosen-select" name="citizenship">
                                                                        ...
                                                                        {
                                                                        ?>
                                                                        <option <?php if($rowcountry['country'] == $rowgroomlocation['citizenship']) { echo "selected"; } ?>><?php echo $rowcountry['country']; ?></option>
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                  </select>
                                                                ...
                                                                <div class="col-md-6 form-group" id="groomresident">
                                                                    ...
                                                                    <select class="form-select chosen-select" name="resident">
                                                                        <option value="">Select</option>
                                                                        <option <?php if($rowgroomlocation['resident'] == 'Yes') { echo "selected"; } ?>>Yes</option>
                                                                        <option <?php if($rowgroomlocation['resident'] == 'No') { echo "selected"; } ?>>No</option>
                                                                    </select>
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <span class="iconbox">
                                                                        <select class="form-select chosen-select" id="groomstate" name="state" required>
                                                                            ...
                                                                            {
                                                                            ?>
                                                                            <option value="<?php echo str_replace(" ", "_", $rowstate['state']); ?>" <?php if($rowstate['state'] == str_replace("_"," ",$rowgroomlocation['state'])) { echo "selected"; } ?>><?php echo $rowstate['state']; ?></option>
                                                                            <?php
                                                                            }
                                                                            ?>
                                                                      </select>
                                                                ...
                                                                $sqlstate2 = "select distinct(state) from city_state";
                                                                $resultstate2 = mysqli_query($con,$sqlstate2);
                                                                while($rowstate2 = mysqli_fetch_assoc($resultstate2))
                                                                {
                                                                    $state1 = $rowstate2['state'];
                                                                ?>
                                                                <div class="col-md-6 form-group groomcities" id="<?php echo "groom_".str_replace(" ", "_", $state1)?>" <?php if($rowgroomlocation['state'] == str_replace(" ", "_", $state1) ) { echo 'style="display:block"';} else { echo 'style="display:none"';}?> >
                                                                    ...
                                                                    <span class="iconbox">
                                                                        <select class="form-select chosen-select gcity" id="<?php echo "groomcity_".str_replace(" ", "_", $state1)?>" name="city[]">
                                                                            <option value="">Select</option>
                                                                            <?php
                                                                                $sqlcity = "select * from city_state where state = '$state1'";
                                                                                $resultcity = mysqli_query($con,$sqlcity);
                                                                                while($rowcity = mysqli_fetch_assoc($resultcity))
                                                                                {
                                                                            ?>
                                                                            <option <?php if(in_array($rowcity['city'], str_replace("-", " ", $cityarray))) { echo "selected"; }?> value="<?php echo $rowcity['city']; ?>"><?php echo $rowcity['city']; ?></option>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </select>
                                                                ...
                                                                <!--<div class="col-md-6 form-group">
                                                                    ...
                                                                    <span class="iconbox">
                                                                        <input type="text" class="form-control leftspace" placeholder="Enter Details" name="groomorigin " value="<?php echo $rowgroomlocation['groomancestralorigin']; ?>">
                                                            ...
                                                            <div class="row p-4">
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <select class="form-select chosen-select" name="familyvalue">
                                                                        <option value="">Select</option>
                                                                        <option <?php if($rowfamilyinfo['familyvalue'] == 'Orthodox') { echo "selected"; } ?>>Orthodox</option>
                                                                        <option <?php if($rowfamilyinfo['familyvalue'] == 'Traditional') { echo "selected"; } ?>>Traditional</option>
                                                                        <option <?php if($rowfamilyinfo['familyvalue'] == 'Moderate') { echo "selected"; } ?>>Moderate</option>
                                                                        <option <?php if($rowfamilyinfo['familyvalue'] == 'Liberal') { echo "selected"; } ?>>Liberal</option>
                                                                  </select>
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <select class="form-select chosen-select" name="familytype" id="familytype" required>
                                                                        <option value="">Select</option>
                                                                        <option <?php if($rowfamilyinfo['familytype'] == 'Joint Family') { echo "selected"; } ?>>Joint Family</option>
                                                                        <option <?php if($rowfamilyinfo['familytype'] == 'Nuclear Family') { echo "selected"; } ?>>Nuclear Family</option>
                                                                  </select>
                                                                  <span class="material-symbols-outlined icon">diversity_3</span>
                                                                    </span>
                                                                </div>
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <span class="iconbox">
                                                                    <select class="form-select chosen-select" name="familystatus" id="familystatus" required>
                                                                        <option value="">Select</option>
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <select class="form-select chosen-select" name="brothers">
                                                                        <option value="">Select</option>
                                                                        <option <?php if($rowfamilyinfo['brothers'] == '0') { echo "selected"; } ?>>0</option>
                                                                        <option <?php if($rowfamilyinfo['brothers'] == '1') { echo "selected"; } ?>>1</option>
                                                                        <option <?php if($rowfamilyinfo['brothers'] == '2') { echo "selected"; } ?>>2</option>
                                                                        <option <?php if($rowfamilyinfo['brothers'] == '3') { echo "selected"; } ?>>3</option>
                                                                        <option <?php if($rowfamilyinfo['brothers'] == '4') { echo "selected"; } ?>>4</option>
                                                                        <option <?php if($rowfamilyinfo['brothers'] == '5') { echo "selected"; } ?>>5</option>
                                                                        <option <?php if($rowfamilyinfo['brothers'] == '6') { echo "selected"; } ?>>6</option>
                                                                        <option <?php if($rowfamilyinfo['brothers'] == '7') { echo "selected"; } ?>>7</option>
                                                                        <option <?php if($rowfamilyinfo['brothers'] == '8') { echo "selected"; } ?>>8</option>
                                                                        <option <?php if($rowfamilyinfo['brothers'] == '9') { echo "selected"; } ?>>9</option>
                                                                        <option <?php if($rowfamilyinfo['brothers'] == '10') { echo "selected"; } ?>>10</option>
                                                                  </select>
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <select class="form-select chosen-select" name="bromarried">
                                                                        <option value="">Select</option>
                                                                        <option <?php if($rowfamilyinfo['bromarried'] == '0') { echo "selected"; } ?>>0</option>
                                                                        <option <?php if($rowfamilyinfo['bromarried'] == '1') { echo "selected"; } ?>>1</option>
                                                                        <option <?php if($rowfamilyinfo['bromarried'] == '2') { echo "selected"; } ?>>2</option>
                                                                        <option <?php if($rowfamilyinfo['bromarried'] == '3') { echo "selected"; } ?>>3</option>
                                                                        <option <?php if($rowfamilyinfo['bromarried'] == '4') { echo "selected"; } ?>>4</option>
                                                                        <option <?php if($rowfamilyinfo['bromarried'] == '5') { echo "selected"; } ?>>5</option>
                                                                        <option <?php if($rowfamilyinfo['bromarried'] == '6') { echo "selected"; } ?>>6</option>
                                                                        <option <?php if($rowfamilyinfo['bromarried'] == '7') { echo "selected"; } ?>>7</option>
                                                                        <option <?php if($rowfamilyinfo['bromarried'] == '8') { echo "selected"; } ?>>8</option>
                                                                        <option <?php if($rowfamilyinfo['bromarried'] == '9') { echo "selected"; } ?>>9</option>
                                                                        <option <?php if($rowfamilyinfo['bromarried'] == '10') { echo "selected"; } ?>>10</option>
                                                                  </select>
                                                                    <span class="material-symbols-outlined icon">diversity_4</span>
                                                                    </span>
                                                                </div>
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <select class="form-select chosen-select" name="sisters">
                                                                        <option value="">Select</option>
                                                                        <option <?php if($rowfamilyinfo['sisters'] == '0') { echo "selected"; } ?>>0</option>
                                                                        <option <?php if($rowfamilyinfo['sisters'] == '1') { echo "selected"; } ?>>1</option>
                                                                        <option <?php if($rowfamilyinfo['sisters'] == '2') { echo "selected"; } ?>>2</option>
                                                                        <option <?php if($rowfamilyinfo['sisters'] == '3') { echo "selected"; } ?>>3</option>
                                                                        <option <?php if($rowfamilyinfo['sisters'] == '4') { echo "selected"; } ?>>4</option>
                                                                        <option <?php if($rowfamilyinfo['sisters'] == '5') { echo "selected"; } ?>>5</option>
                                                                        <option <?php if($rowfamilyinfo['sisters'] == '6') { echo "selected"; } ?>>6</option>
                                                                        <option <?php if($rowfamilyinfo['sisters'] == '7') { echo "selected"; } ?>>7</option>
                                                                        <option <?php if($rowfamilyinfo['sisters'] == '8') { echo "selected"; } ?>>8</option>
                                                                        <option <?php if($rowfamilyinfo['sisters'] == '9') { echo "selected"; } ?>>9</option>
                                                                        <option <?php if($rowfamilyinfo['sisters'] == '10') { echo "selected"; } ?>>10</option>
                                                                  </select>
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <select class="form-select chosen-select" name="sismarried">
                                                                        <option value="">Select</option>
                                                                        <option <?php if($rowfamilyinfo['sismarried'] == '0') { echo "selected"; } ?>>0</option>
                                                                        <option <?php if($rowfamilyinfo['sismarried'] == '1') { echo "selected"; } ?>>1</option>
                                                                        <option <?php if($rowfamilyinfo['sismarried'] == '2') { echo "selected"; } ?>>2</option>
                                                                        <option <?php if($rowfamilyinfo['sismarried'] == '3') { echo "selected"; } ?>>3</option>
                                                                        <option <?php if($rowfamilyinfo['sismarried'] == '4') { echo "selected"; } ?>>4</option>
                                                                        <option <?php if($rowfamilyinfo['sismarried'] == '5') { echo "selected"; } ?>>5</option>
                                                                        <option <?php if($rowfamilyinfo['sismarried'] == '6') { echo "selected"; } ?>>6</option>
                                                                        <option <?php if($rowfamilyinfo['sismarried'] == '7') { echo "selected"; } ?>>7</option>
                                                                        <option <?php if($rowfamilyinfo['sismarried'] == '8') { echo "selected"; } ?>>8</option>
                                                                        <option <?php if($rowfamilyinfo['sismarried'] == '9') { echo "selected"; } ?>>9</option>
                                                                        <option <?php if($rowfamilyinfo['sismarried'] == '10') { echo "selected"; } ?>>10</option>
                                                                  </select>
                                                                    <span class="material-symbols-outlined icon">diversity_4</span>
                                                                    </span>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <select class="form-select chosen-select" name="familylocation" id="familylocation" required>
                                                                        <option value="">Select</option>
                                                                        <option <?php if($rowfamilyinfo['familylocation'] == 'Same as my location') { echo "selected"; } ?>>Same as my location</option>
                                                                        <option <?php if($rowfamilyinfo['familylocation'] == 'Different Location') { echo "selected"; } ?>>Different Location</option>
                                                                  </select>
                                                                    <span class="material-symbols-outlined icon">location_on</span>
                                                                    </span>
                                                                </div>
                                                                <div class="col-md-6 form-group familycountry" <?php if($rowfamilyinfo['familylocation'] == 'Different Location') { echo "style='display:block'"; } else { echo "style='display:none'"; } ?>>
                                                                    ...
                                                                    <select class="form-select chosen-select" name="country" id="diffcountry">
                                                                        ...
                                                                        {
                                                                        ?>
                                                                        <option <?php if($rowcountry['country'] == $rowfamilyinfo['country']) { echo "selected"; } ?>><?php echo $rowcountry['country']; ?></option>
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                  </select>
                                                                ...
                                                                <div class="col-md-6 form-group familystate" <?php if($rowfamilyinfo['familylocation'] == 'Different Location') { echo "style='display:block'"; } else { echo "style='display:none'"; } ?>>
                                                                    ...
                                                                    <select class="form-select chosen-select" id="familystate" name="state">
                                                                        ...
                                                                        {
                                                                        ?>
                                                                        <option value="<?php echo str_replace(" ", "_", $rowstate['state']); ?>" <?php if($rowstate['state'] == $rowfamilyinfo['state']) { echo "selected"; } ?>><?php echo $rowstate['state']; ?></option>
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                  </select>
                                                                ...
                                                                ?>
                                                                <div class="col-md-6 form-group familycities" id="<?php echo str_replace(" ", "_", $state)?>" <?php if($rowfamilyinfo['familylocation'] == 'Different Location' && $rowfamilyinfo['state'] == $state) { echo 'style="display:block"'; } else { echo 'style="display:none"'; }?>>
                                                                    ...
                                                                    <span class="iconbox">
                                                                        <select class="form-select chosen-select gc" id="<?php echo "gc_".str_replace(" ", "_", $state)?>" name="city[]">
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                {
                                                                            ?>
                                                                            <option <?php if($rowfamilyinfo['city'] == $rowcity['city']) { echo "selected"; }?> value="<?php echo $rowcity['city']; ?>"><?php echo $rowcity['city']; ?></option>
                                                                            <?php
                                                                                }
                                                                            ?>
                                                                        </select>
                                                            ...
                                                            <div class="row p-4">
                                                                ...
                                                                <div class="col-md-12 form-group">
                                                                    ...
                                                                    <select class="form-select chosen-select" name="hobbies[]" placeholder="select" multiple>
                                                                        <option value="">Select</option>
                                                                        <option <?php if(in_array("Art / handcraft", $hobbies)) { echo "selected"; }?>>Art / handcraft</option>
                                                                        <option <?php if(in_array("Cooking", $hobbies)) { echo "selected"; }?>>Cooking</option>
                                                                        <option <?php if(in_array("Dancing", $hobbies)) { echo "selected"; }?>>Dancing</option>
                                                                        <option <?php if(in_array("Gardening / Landscaping", $hobbies)) { echo "selected"; }?>>Gardening / Landscaping</option>
                                                                        <option <?php if(in_array("Nature", $hobbies)) { echo "selected"; }?>>Nature</option> 
                                                                        <option <?php if(in_array("Painting", $hobbies)) { echo "selected"; }?>>Painting</option>
                                                                        <option <?php if(in_array("Pets", $hobbies)) { echo "selected"; }?>>Pets</option>
                                                                        <option <?php if(in_array("Photography", $hobbies)) { echo "selected"; }?>>Photography</option>
                                                                        <option <?php if(in_array("Playing musical instruments", $hobbies)) { echo "selected"; }?>>Playing musical instruments</option>
                                                                        <option <?php if(in_array("Puzzles", $hobbies)) { echo "selected"; }?>>Puzzles</option>
                                                                        <option <?php if(in_array("Internet Surfing", $hobbies)) { echo "selected"; }?>>Internet Surfing</option>
                                                                        <option <?php if(in_array("Listening to music", $hobbies)) { echo "selected"; }?>>Listening to music</option>
                                                                        <option <?php if(in_array("Movies", $hobbies)) { echo "selected"; }?>>Movies</option>
                                                                        <option <?php if(in_array("Travelling", $hobbies)) { echo "selected"; }?>>Travelling</option>
                                                                  </select>
                                                                ...
                                                                <div class="col-md-12 form-group">
                                                                    ...
                                                                    <select class="form-select chosen-select" name="music[]" multiple>
                                                                        <option value="">Select</option>
                                                                        <option <?php if(in_array("Film Songs", $music)) { echo "selected"; }?>>Film Songs</option>
                                                                        <option <?php if(in_array("Indian / Classical Music", $music)) { echo "selected"; }?>>Indian / Classical Music</option>
                                                                        <option <?php if(in_array("Western Music", $music)) { echo "selected"; }?>>Western Music</option>
                                                                  </select>
                                                                ...
                                                                <div class="col-md-12 form-group">
                                                                    ...
                                                                    <select class="form-select chosen-select" name="sports[]" multiple>
                                                                        <option value="">Select</option>
                                                                        <option <?php if(in_array("Badminton", $sports)) { echo "selected"; }?>>Badminton</option>
                                                                        <option <?php if(in_array("Carrom", $sports)) { echo "selected"; }?>>Carrom</option>
                                                                        <option <?php if(in_array("Chess", $sports)) { echo "selected"; }?>>Chess</option>
                                                                        <option <?php if(in_array("cricket", $sports)) { echo "selected"; }?>>cricket</option>
                                                                        <option <?php if(in_array("Football", $sports)) { echo "selected"; }?>>Football</option>
                                                                        <option <?php if(in_array("Jogging", $sports)) { echo "selected"; }?>>Jogging</option>
                                                                        <option <?php if(in_array("Swimming", $sports)) { echo "selected"; }?>>Swimming</option>
                                                                  </select>
                                                                ...
                                                                <div class="col-md-12 form-group">
                                                                    ...
                                                                    <select class="form-select chosen-select" name="food[]" multiple>
                                                                        <option value="">Select</option>
                                                                        <option <?php if(in_array("Arabic", $food)) { echo "selected"; }?>>Arabic</option>
                                                                        <option <?php if(in_array("Bengali", $food)) { echo "selected"; }?>>Bengali</option>
                                                                        <option <?php if(in_array("Chinese", $food)) { echo "selected"; }?>>Chinese</option>
                                                                        <option <?php if(in_array("Continental", $food)) { echo "selected"; }?>>Continental</option>
                                                                        <option <?php if(in_array("Fast Food", $food)) { echo "selected"; }?>>Fast Food</option>
                                                                        <option <?php if(in_array("Gujarati", $food)) { echo "selected"; }?>>Gujarati</option>
                                                                        <option <?php if(in_array("Italian", $food)) { echo "selected"; }?>>Italian</option>
                                                                        <option <?php if(in_array("Konkan", $food)) { echo "selected"; }?>>Konkan</option>
                                                                        <option <?php if(in_array("Mexican", $food)) { echo "selected"; }?>>Mexican</option>
                                                                        <option <?php if(in_array("Moghlai", $food)) { echo "selected"; }?>>Moghlai</option>
                                                                        <option <?php if(in_array("Punjabi", $food)) { echo "selected"; }?>>Punjabi</option>
                                                                        <option <?php if(in_array("Rajasthani", $food)) { echo "selected"; }?>>Rajasthani</option>
                                                                        <option <?php if(in_array("South Indian", $food)) { echo "selected"; }?>>South Indian</option>
                                                                        <option <?php if(in_array("Spanish", $food)) { echo "selected"; }?>>Spanish</option>
                                                                        <option <?php if(in_array("Sushi", $food)) { echo "selected"; }?>>Sushi</option>
                                                                  </select>
                                                                   <span class="material-symbols-outlined icon">restaurant</span>
                                                                    </span>
                                                                </div>
                                                                ...
                                                                <div class="row p-4 pb-0">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <select class="form-select chosen-select" name="partneragefrom" id="partneragefrom" required>
                                                                                    ...
                                                                                    {
                                                                                    ?>
                                                                                    <option <?php if($partnerage['0'] == $from.' Yrs') { echo "selected"; } ?>><?php echo $from ?> Yrs</option>
                                                                                    <?php
                                                                                    }
                                                                                    ?>
                                                                                </select>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <select class="form-select chosen-select" name="partnerageto" id="partnerageto" required>
                                                                                    ...
                                                                                    {
                                                                                    ?>
                                                                                    <option <?php if($partnerage['1'] == $to.' Yrs') { echo "selected"; } ?>><?php echo $to ?> Yrs</option>
                                                                                    <?php
                                                                                    }
                                                                                    ?>
                                                                                </select>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <span class="iconbox">
                                                                                    <select class="form-select chosen-select" name="partnerheightfrom" id="partnerheightfrom" required>
                                                                                        <option value="">Select</option>
                                                                                        <option <?php if($partnerheight['0'] == '4 Feet 5 Inches') { echo "selected"; } ?>>4 Feet 5 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '4 Feet 6 Inches') { echo "selected"; } ?>>4 Feet 6 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '4 Feet 7 Inches') { echo "selected"; } ?>>4 Feet 7 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '4 Feet 8 Inches') { echo "selected"; } ?>>4 Feet 8 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '4 Feet 9 Inches') { echo "selected"; } ?>>4 Feet 9 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '4 Feet 10 Inches') { echo "selected"; } ?>>4 Feet 10 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '4 Feet 11 Inches') { echo "selected"; } ?>>4 Feet 11 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '5 Feet 0 Inches') { echo "selected"; } ?>>5 Feet 0 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '5 Feet 1 Inches') { echo "selected"; } ?>>5 Feet 1 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '5 Feet 2 Inches') { echo "selected"; } ?>>5 Feet 2 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '5 Feet 3 Inches') { echo "selected"; } ?>>5 Feet 3 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '5 Feet 4 Inches') { echo "selected"; } ?>>5 Feet 4 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '5 Feet 5 Inches') { echo "selected"; } ?>>5 Feet 5 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '5 Feet 6 Inches') { echo "selected"; } ?>>5 Feet 6 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '5 Feet 7 Inches') { echo "selected"; } ?>>5 Feet 7 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '5 Feet 8 Inches') { echo "selected"; } ?>>5 Feet 8 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '5 Feet 9 Inches') { echo "selected"; } ?>>5 Feet 9 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '5 Feet 10 Inches') { echo "selected"; } ?>>5 Feet 10 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '5 Feet 11 Inches') { echo "selected"; } ?>>5 Feet 11 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '6 Feet 0 Inches') { echo "selected"; } ?>>6 Feet 0 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '6 Feet 1 Inches') { echo "selected"; } ?>>6 Feet 1 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '6 Feet 2 Inches') { echo "selected"; } ?>>6 Feet 2 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '6 Feet 3 Inches') { echo "selected"; } ?>>6 Feet 3 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '6 Feet 4 Inches') { echo "selected"; } ?>>6 Feet 4 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '6 Feet 5 Inches') { echo "selected"; } ?>>6 Feet 5 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '6 Feet 6 Inches') { echo "selected"; } ?>>6 Feet 6 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '6 Feet 7 Inches') { echo "selected"; } ?>>6 Feet 7 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '6 Feet 8 Inches') { echo "selected"; } ?>>6 Feet 8 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '6 Feet 9 Inches') { echo "selected"; } ?>>6 Feet 9 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '6 Feet 10 Inches') { echo "selected"; } ?>>6 Feet 10 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '6 Feet 11 Inches') { echo "selected"; } ?>>6 Feet 11 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '7 Feet 0 Inches') { echo "selected"; } ?>>7 Feet 0 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '7 Feet 1 Inches') { echo "selected"; } ?>>7 Feet 1 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '7 Feet 2 Inches') { echo "selected"; } ?>>7 Feet 2 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '7 Feet 3 Inches') { echo "selected"; } ?>>7 Feet 3 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '7 Feet 4 Inches') { echo "selected"; } ?>>7 Feet 4 Inches</option>
                                                                                        <option <?php if($partnerheight['0'] == '7 Feet 5 Inches') { echo "selected"; } ?>>7 Feet 5 Inches</option>
                                                                                  </select>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <span class="iconbox">
                                                                                    <select class="form-select chosen-select" name="partnerheightto" id="partnerheightto" required>
                                                                                        <option value="">Select</option>
                                                                                        <option <?php if($partnerheight['1'] == '4 Feet 5 Inches') { echo "selected"; } ?>>4 Feet 5 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '4 Feet 6 Inches') { echo "selected"; } ?>>4 Feet 6 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '4 Feet 7 Inches') { echo "selected"; } ?>>4 Feet 7 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '4 Feet 8 Inches') { echo "selected"; } ?>>4 Feet 8 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '4 Feet 9 Inches') { echo "selected"; } ?>>4 Feet 9 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '4 Feet 10 Inches') { echo "selected"; } ?>>4 Feet 10 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '4 Feet 11 Inches') { echo "selected"; } ?>>4 Feet 11 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '5 Feet 0 Inches') { echo "selected"; } ?>>5 Feet 0 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '5 Feet 1 Inches') { echo "selected"; } ?>>5 Feet 1 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '5 Feet 2 Inches') { echo "selected"; } ?>>5 Feet 2 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '5 Feet 3 Inches') { echo "selected"; } ?>>5 Feet 3 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '5 Feet 4 Inches') { echo "selected"; } ?>>5 Feet 4 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '5 Feet 5 Inches') { echo "selected"; } ?>>5 Feet 5 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '5 Feet 6 Inches') { echo "selected"; } ?>>5 Feet 6 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '5 Feet 7 Inches') { echo "selected"; } ?>>5 Feet 7 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '5 Feet 8 Inches') { echo "selected"; } ?>>5 Feet 8 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '5 Feet 9 Inches') { echo "selected"; } ?>>5 Feet 9 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '5 Feet 10 Inches') { echo "selected"; } ?>>5 Feet 10 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '5 Feet 11 Inches') { echo "selected"; } ?>>5 Feet 11 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '6 Feet 0 Inches') { echo "selected"; } ?>>6 Feet 0 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '6 Feet 1 Inches') { echo "selected"; } ?>>6 Feet 1 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '6 Feet 2 Inches') { echo "selected"; } ?>>6 Feet 2 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '6 Feet 3 Inches') { echo "selected"; } ?>>6 Feet 3 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '6 Feet 4 Inches') { echo "selected"; } ?>>6 Feet 4 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '6 Feet 5 Inches') { echo "selected"; } ?>>6 Feet 5 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '6 Feet 6 Inches') { echo "selected"; } ?>>6 Feet 6 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '6 Feet 7 Inches') { echo "selected"; } ?>>6 Feet 7 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '6 Feet 8 Inches') { echo "selected"; } ?>>6 Feet 8 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '6 Feet 9 Inches') { echo "selected"; } ?>>6 Feet 9 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '6 Feet 10 Inches') { echo "selected"; } ?>>6 Feet 10 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '6 Feet 11 Inches') { echo "selected"; } ?>>6 Feet 11 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '7 Feet 0 Inches') { echo "selected"; } ?>>7 Feet 0 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '7 Feet 1 Inches') { echo "selected"; } ?>>7 Feet 1 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '7 Feet 2 Inches') { echo "selected"; } ?>>7 Feet 2 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '7 Feet 3 Inches') { echo "selected"; } ?>>7 Feet 3 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '7 Feet 4 Inches') { echo "selected"; } ?>>7 Feet 4 Inches</option>
                                                                                        <option <?php if($partnerheight['1'] == '7 Feet 5 Inches') { echo "selected"; } ?>>7 Feet 5 Inches</option>
                                                                                  </select>
                                                                                    <span class="material-symbols-outlined icon">height</span>
                                                                                </span>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-6 form-group">
                                                                        ...
                                                                        <select class="form-select chosen-select" name="partnermarital" id="partnermarital" required>
                                                                            <option value="">Select</option>
                                                                            <option <?php if($rowpartnerinfo['partnermarital'] == 'Never Married') { echo "selected"; } ?>>Never Married</option>
                                                                            <option <?php if($rowpartnerinfo['partnermarital'] == 'Divorced') { echo "selected"; } ?>>Divorced</option>
                                                                            <option <?php if($rowpartnerinfo['partnermarital'] == 'Widowed') { echo "selected"; } ?>>Widowed</option>
                                                                            <option <?php if($rowpartnerinfo['partnermarital'] == 'Awaiting Divorce') { echo "selected"; } ?>>Awaiting Divorce</option>
                                                                      </select>
                                                                      <span class="material-symbols-outlined icon">diversity_4</span>
                                                                    </span>
                                                                    </div>
                                                                    <!--<div class="col-md-6 form-group">
                                                                        ...
                                                                        <select class="form-select chosen-select" name="partnerphysical">
                                                                            <option value="">Select</option>
                                                                            <option <?php if($rowpartnerinfo['partnerphysical'] == 'Normal') { echo "selected"; } ?>>Normal</option>
                                                                            <option <?php if($rowpartnerinfo['partnerphysical'] == 'Handicapped by birth') { echo "selected"; } ?>>Handicapped by birth</option>
                                                                            <option <?php if($rowpartnerinfo['partnerphysical'] == 'Handicapped by war') { echo "selected"; } ?>>Handicapped by war</option>
                                                                      </select>
                                                                    ...
                                                                    <div class="col-md-6 form-group">
                                                                        ...
                                                                        <select class="form-select chosen-select" name="partnereating">
                                                                            <option value="">Select</option>
                                                                            <option <?php if($rowpartnerinfo['partnereating'] == 'Vegetarian') { echo "selected"; } ?>>Vegetarian</option>
                                                                            <option <?php if($rowpartnerinfo['partnereating'] == 'Non-Vegetarian') { echo "selected"; } ?>>Non-Vegetarian</option>
                                                                            <option <?php if($rowpartnerinfo['partnereating'] == 'Eggetarian') { echo "selected"; } ?>>Eggetarian</option>
                                                                            <otpion <?php if($rowpartnerinfo['partnereating'] == 'Vegan') { echo "selected"; } ?>>Vegan</otpion>
                                                                      </select>
                                                                      <span class="material-symbols-outlined icon">restaurant</span>
                                                                    </span>
                                                                    </div>
                                                                    <div class="col-md-6 form-group">
                                                                        ...
                                                                        <select class="form-select chosen-select" name="partnerdrinking">
                                                                            <option value="">Select</option>
                                                                            <option <?php if($rowpartnerinfo['partnerdrinking'] == 'Non-drinker') { echo "selected"; } ?>>Non-drinker</option>
                                                                            <option <?php if($rowpartnerinfo['partnerdrinking'] == 'Light / Social drinker') { echo "selected"; } ?>>Light / Social drinker</option>
                                                                            <option <?php if($rowpartnerinfo['partnerdrinking'] == 'Regular drinker') { echo "selected"; } ?>>Regular drinker</option>
                                                                      </select>
                                                                      <span class="material-symbols-outlined icon">liquor</span>
                                                                    </span>
                                                                    </div>
                                                                    <div class="col-md-6 form-group">
                                                                        ...
                                                                        <select class="form-select chosen-select" name="partnersmoking">
                                                                            <option value="">Select</option>
                                                                            <option <?php if($rowpartnerinfo['partnersmoking'] == 'Non-smoker') { echo "selected"; } ?>>Non-smoker</option>
                                                                            <option <?php if($rowpartnerinfo['partnersmoking'] == 'Light / Social smoker') { echo "selected"; } ?>>Light / Social smoker</option>
                                                                            <option <?php if($rowpartnerinfo['partnersmoking'] == 'Regular Smoker') { echo "selected"; } ?>>Regular Smoker</option>
                                                                      </select>
                                                                ...
                                                                <div class="row p-4 pb-0">
                                                                    ...
                                                                    <div class="col-md-6 form-group">
                                                                        ...
                                                                        <select class="form-select chosen-select" name="partnermanglik">
                                                                            <option value="">Select</option>
                                                                            <option <?php if($rowpartnerinfo['partnermanglik'] == 'Yes') { echo "selected"; } ?>>Yes</option>
                                                                            <option <?php if($rowpartnerinfo['partnermanglik'] == 'No') { echo "selected"; } ?>>No</option>
                                                                            <option <?php if($rowpartnerinfo['partnermanglik'] == 'Dont Know') { echo "selected"; } ?>>Dont Know</option>
                                                                      </select>
                                                                      <span class="material-symbols-outlined icon">error</span>
                                                                    </span>
                                                                    </div>
                                                                ...
                                                                <div class="row p-4 pb-0">
                                                                    ...
                                                                    <div class="col-md-12 form-group">
                                                                        ...
                                                                        <select class="form-select chosen-select" id="partnerreligion" name="partnerreligion[]" multiple required>
                                                                            ...
                                                                            {
                                                                            ?>
                                                                            <option <?php if(in_array($rowreligion1['religion'],$partnerreligion)) { echo "selected"; } ?> value="<?php echo $rowreligion1['religion']; ?>"><?php echo $rowreligion1['religion']; ?></option>
                                                                            <?php
                                                                            }
                                                                            ?>
                                                                      </select>
                                                                    ...
                                                                    <div class="col-md-12 form-group">
                                                                        ...
                                                                        <select class="form-select chosen-select" name="caste[]" id="partnercaste" multiple required>
                                                                            ...
                                                                            {
                                                                            ?>
                                                                                <option <?php if(in_array($rowgetpartnercaste['caste'],$partnercaste)) { echo "selected"; } ?>><?php echo $rowgetpartnercaste['caste'];?></option>
                                                                            <?php
                                                                            }
                                                                            ?>
                                                                      </select>
                                                                    ...
                                                                    <div class="form-group form-check">
                                                                        <label class="form-check-label">
                                                                            <input class="form-check-input" type="checkbox" name="castebar" value="yes" <?php if($rowpartnerinfo['castebar'] == 'yes') { echo "checked"; } ?>> Caste No Bar
                                                                        </label>
                                                                    </div>
                                                                    </div>
                                                                    <!--<div class="col-md-6 form-group">
                                                                ...
                                                                <div class="row p-4 pb-0">
                                                                    ...
                                                                    <div class="col-md-12 form-group">
                                                                        ...
                                                                        <select class="form-select chosen-select" id="partnerstream" name="partnerstream[]" multiple required>
                                                                            ...
                                                                            {
                                                                            ?>
                                                                            <option <?php if(in_array($rowstream['stream'],$partnerstream)) { echo "selected"; } ?>><?php echo $rowstream['stream']; ?></option>
                                                                            <?php
                                                                            }
                                                                            ?>
                                                                      </select>
                                                                    ...
                                                                    <div class="col-md-12 form-group">
                                                                        ...
                                                                        <select class="form-select chosen-select" name="education[]" id="partnereducation" multiple>
                                                                            ...
                                                                            {
                                                                            ?>
                                                                                <option <?php if(in_array($rowgetpartnereducation['education'],$partnereducation)) { echo "selected"; } ?>><?php echo $rowgetpartnereducation['education'];?></option>
                                                                            <?php
                                                                            }
                                                                            ?>
                                                                      </select>
                                                                    ...
                                                                    <div class="col-md-12 form-group">
                                                                        ...
                                                                        <select class="form-select chosen-select" name="partnerprofession[]" id="partnerprofession" multiple required>
                                                                            <option value="">Select</option>
                                                                            <option <?php if(in_array('Private Company/Corporate',$partnerprofession)) { echo "selected"; } ?>>Private Company/Corporate</option>
                                                                            <option <?php if(in_array('Government/Public Sector',$partnerprofession)) { echo "selected"; } ?>>Government/Public Sector</option>
                                                                            <option <?php if(in_array('Defence Services',$partnerprofession)) { echo "selected"; } ?>>Defence Services</option>
                                                                            <option <?php if(in_array('Civil Services',$partnerprofession)) { echo "selected"; } ?>>Civil Services</option>
                                                                            <option <?php if(in_array('Business/Self Employed',$partnerprofession)) { echo "selected"; } ?>>Business/Self Employed</option>
                                                                            <option <?php if(in_array('Not Working',$partnerprofession)) { echo "selected"; } ?>>Not Working</option>
                                                                      </select>
                                                                      <span class="material-symbols-outlined icon">work</span>
                                                                    </span>
                                                                    </div>
                                                                    <div class="col-md-12 form-group">
                                                                        ...
                                                                        <select class="form-select chosen-select" id="partnerdomain" name="partnerdomain[]" multiple>
                                                                            ...
                                                                            {
                                                                            ?>
                                                                            <option <?php if(in_array($rowdomain['domain'],$partnerdomain)) { echo "selected"; } ?>><?php echo $rowdomain['domain']; ?></option>
                                                                            <?php
                                                                            }
                                                                            ?>
                                                                      </select>
                                                                    ...
                                                                    <div class="col-md-6 form-group">
                                                                        ...
                                                                        <select class="form-select chosen-select" name="partnerincome" id="partnerincome" required>
                                                                            <option value="">Select</option>
                                                                            <option <?php if($rowpartnerinfo['partnerincome'] == 'Upto 1 Lakhs') { echo "selected"; } ?>>Upto 1 Lakhs</option>
                                                                            <option <?php if($rowpartnerinfo['partnerincome'] == '1 Lakhs - 2 Lakhs') { echo "selected"; } ?>>1 Lakhs - 2 Lakhs</option>
                                                                            <option <?php if($rowpartnerinfo['partnerincome'] == '2 Lakhs - 5 Lakhs') { echo "selected"; } ?>>2 Lakhs - 5 Lakhs</option>
                                                                            <option <?php if($rowpartnerinfo['partnerincome'] == '5 Lakhs - 7 Lakhs') { echo "selected"; } ?>>5 Lakhs - 7 Lakhs</option>
                                                                            <option <?php if($rowpartnerinfo['partnerincome'] == '7 Lakhs - 10 Lakhs') { echo "selected"; } ?>>7 Lakhs - 10 Lakhs</option>
                                                                            <option <?php if($rowpartnerinfo['partnerincome'] == '10 Lakhs - 15 Lakhs') { echo "selected"; } ?>>10 Lakhs - 15 Lakhs</option>
                                                                            <option <?php if($rowpartnerinfo['partnerincome'] == '15 Lakhs - 20 Lakhs') { echo "selected"; } ?>>15 Lakhs - 20 Lakhs</option>
                                                                            <option <?php if($rowpartnerinfo['partnerincome'] == '20 Lakhs - 25 Lakhs') { echo "selected"; } ?>>20 Lakhs - 25 Lakhs</option>
                                                                            <option <?php if($rowpartnerinfo['partnerincome'] == '25 Lakhs - 30 Lakhs') { echo "selected"; } ?>>25 Lakhs - 30 Lakhs</option>
                                                                            <option <?php if($rowpartnerinfo['partnerincome'] == '30 Lakhs - 50 Lakhs') { echo "selected"; } ?>>30 Lakhs - 50 Lakhs</option>
                                                                            <option <?php if($rowpartnerinfo['partnerincome'] == '50 Lakhs - 75 Lakhs') { echo "selected"; } ?>>50 Lakhs - 75 Lakhs</option>
                                                                            <option <?php if($rowpartnerinfo['partnerincome'] == '75 Lakhs - 1 Crore') { echo "selected"; } ?>>75 Lakhs - 1 Crore</option>
                                                                            <option <?php if($rowpartnerinfo['partnerincome'] == '1 Crore and Above') { echo "selected"; } ?>>1 Crore and Above</option>
                                                                      </select>
                                                                      <span class="material-symbols-outlined icon">currency_rupee</span>
                                                                    </span>
                                                                    </div>
                                                                ...
                                                                <div class="row p-4 pb-0">
                                                                    ...
                                                                    <div class="col-md-12 form-group">
                                                                        ...
                                                                        <select class="form-select chosen-select" name="partnercountry[]" id="partnercountry" multiple required>
                                                                            ...
                                                                            {
                                                                            ?>
                                                                            <option <?php if(in_array($rowcountry['country'],$partnercountry)) { echo "selected"; } ?>><?php echo $rowcountry['country']; ?></option>
                                                                            <?php
                                                                            }
                                                                            ?>
                                                                      </select>
                                                                    ...
                                                                    <div class="col-md-12 form-group">
                                                                        ...
                                                                        <select class="form-select chosen-select" id="partnerstate" name="partnerstate[]"  multiple required>
                                                                            ...
                                                                            {
                                                                            ?>
                                                                            <option <?php if(in_array($rowstate['state'],str_replace("-", " ",$partnerstate))) { echo "selected"; } ?>><?php echo $rowstate['state']; ?></option>
                                                                            <?php
                                                                            }
                                                                            ?>
                                                                      </select>
                                                                    ...
                                                                    <div class="col-md-12 form-group" id="partnercity">
                                                                        ...
                                                                        <select class="form-select chosen-select" name="city[]" multiple>
                                                                            ...
                                                                            {
                                                                            ?>
                                                                                <option <?php if(in_array($rowgetpartnercity['city'],$partnercity)) { echo "selected"; } ?>><?php echo $rowgetpartnercity['city'];?></option>
                                                                            <?php
                                                                            }
                                                                            ?>
                                                                      </select>
                                                            ...
                                                            <div class="row p-4">
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <select class="form-select chosen-select" name="relationship">
                                                                        <option value="">Select</option>
                                                                        <option <?php if($rowcontactinfo['relationship'] == 'Son') { echo "selected"; }?>>Son</option>
                                                                        <option <?php if($rowcontactinfo['relationship'] == 'Daughter') { echo "selected"; }?>>Daughter</option>
                                                                        <option <?php if($rowcontactinfo['relationship'] == 'Brother') { echo "selected"; }?>>Brother</option>
                                                                        <option <?php if($rowcontactinfo['relationship'] == 'Sister') { echo "selected"; }?>>Sister</option>
                                                                        <option <?php if($rowcontactinfo['relationship'] == 'Friends') { echo "selected"; }?>>Friends</option>
                                                                        <option <?php if($rowcontactinfo['relationship'] == 'Relative') { echo "selected"; }?>>Relative</option>
                                                                        <option <?php if($rowcontactinfo['relationship'] == 'Others') { echo "selected"; }?>>Others</option>
                                                                  </select>
                                                        ...
                                                        <div class="edit-pro-parti">
                                                            ...
                                                            <div class="row p-4">
                                                                ...
                                                                <div class="col-md-3 form-group">
                                                                    ...
                                                                    <input type="file" class="form-control lh" id="addphoto1input" name="profilepic" <?php if($rowformfill['profilestatus'] == '0') { echo "disabled"; } ?> style="display:none;" onchange="previewImage1(event)" accept="image/png, image/jpg, image/jpeg">
                                                                    <?php
                                                                    }
                                                                    ?>
                                                                </div>
                                                                <div class="col-md-3 form-group">
                                                                    ...
                                                                    <div class="picborder">
                                                                        <img src="userphoto/<?php echo $rowphotosinfo['photo1']; ?>" class="managephoto">
                                                                    </div>
                                                                    <div>
                                                                        <?php 
                                                                        if($rowformfill['profilestatus'] == '1') 
                                                                    ...
                                                                    <input type="file" class="form-control lh" id="addphoto2input" name="photo1" <?php if($rowformfill['profilestatus'] == '0') { echo "disabled"; } ?> style="display:none;"  onchange="previewImage2(event)" accept="image/png, image/jpg, image/jpeg">
                                                                    <?php
                                                                    }
                                                                    ?>
                                                                </div>
                                                                <div class="col-md-3 form-group">
                                                                    ...
                                                                    <div class="picborder">
                                                                        <img src="userphoto/<?php echo $rowphotosinfo['photo2']; ?>" class="managephoto">
                                                                    </div>
                                                                    <div>
                                                                        <?php 
                                                                        if($rowformfill['profilestatus'] == '1') 
                                                                    ...
                                                                    <input type="file" class="form-control lh" id="addphoto3input" name="photo2" <?php if($rowformfill['profilestatus'] == '0') { echo "disabled"; } ?> style="display:none;"  onchange="previewImage3(event)" accept="image/png, image/jpg, image/jpeg">
                                                                    <?php
                                                                    }
                                                                    ?>
                                                                </div>
                                                                <div class="col-md-3 form-group">
                                                                    ...
                                                                    <div class="picborder">
                                                                        <img src="userphoto/<?php echo $rowphotosinfo['photo3']; ?>" class="managephoto">
                                                                    </div>
                                                                    <div>
                                                                        <?php 
                                                                        if($rowformfill['profilestatus'] == '1') 
                                                                    ...
                                                                    ?>
                                                                    <label class="lb">Picture 3</label>
                                                                    <div class="picborder" id="addphoto4">
                                                                        <img id="preview4" class="managephoto">
                                                                        <span class="material-symbols-outlined" id="addicon4">add_photo_alternate</span>
                                                                        <p class="m-0" id="addbtn4">Add Photo</p>
                                                                    </div>
                                                                    <input type="file" class="form-control lh" id="addphoto4input" name="photo3" <?php if($rowformfill['profilestatus'] == '0') { echo "disabled"; } ?> style="display:none;" onchange="previewImage4(event)" accept="image/png, image/jpg, image/jpeg">
                                                                    <?php
                                                                    }
                                                                    ?>
                                                                </div>
                                                                <!--<div class="col-md-3 form-group">
                                                                    ...
                                                                    ?>
                                                                    <label class="lb">Photo 4:</label>
                                                                    <div class="picborder" id="addphoto5">
                                                                        <span class="material-symbols-outlined">add_photo_alternate</span>
                                                                        <p class="m-0">Add Photo</p>
                                                                    </div>
                                                                    <input type="file" class="form-control lh" id="addphoto5input"  name="photo4" <?php if($rowformfill['profilestatus'] == '0') { echo "disabled"; } ?>>
                                                                    <input type="hidden" class="form-control lh" name="oldphoto4" value="<?php echo $rowphotosinfo['photo4']; ?>">
                                                                </div>
                                                                <div class="col-md-3 form-group">
                                                                    <?php
                                                                    ...
                                                                    ?>
                                                                    <label class="lb">Photo 5:</label>
                                                                    <div class="picborder" id="addphoto6">
                                                                        <span class="material-symbols-outlined">add_photo_alternate</span>
                                                                        <p class="m-0">Add Photo</p>
                                                                    </div>
                                                                    <input type="file" class="form-control lh" id="addphoto6input" name="photo5" <?php if($rowformfill['profilestatus'] == '0') { echo "disabled"; } ?>>
                                                                    <input type="hidden" class="form-control lh" name="oldphoto5" value="<?php echo $rowphotosinfo['photo5']; ?>">
                                                                </div>-->
                                                                <div class="col-md-12 form-group">
                                                                    <p class="mt-4 m-0"><span class="text-danger">Supports:</span> PNG, JPG and JPEG</p>
                                                                </div>
                                                                <div class="col-md-12 form-group">
                                                                    <p class="text-white mt-0 notebox"><b>Note:</b> This section will be reviewed each time you update it. Please allow up to 24 hours for it to go live.</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--END PROFILE BIO-->
...
<script>
    ...
    $('#groomstate').change(function(){
        ...
        if(groomstate == '')
        {
            ...
            $("#groomcity_"+groomstate).prop("required",false);
        }
        else
        {
            $(".groomcities").hide();
