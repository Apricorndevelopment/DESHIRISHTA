...
$sqlcountregis = "select * from registration where delete_status != 'delete' and firstapprove = '1'";
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="all-list-sh">
                            <ul>
                                ...
                                $sqlinfo = "select * from registration where delete_status != 'delete' and firstapprove = '1' order by id $sort limit $lower_limit,3";
                    ...
                    <div class="col-md-4">
                        <div class="page-nation">
                            <ul class="pagination pagination-sm">
                                <?php
                                $sqltotalentry = "select * from registration where delete_status != 'delete' and firstapprove = '1'";
                                ...
                                {
                                ?>
                                <li class="page-item"><a class="page-link" href="search-profile.php?page=<?php echo $page - 1; ?>">Previous</a></li>
                                <?php
                                }
                                if($total_page >= 1)
                                {
                                ?>
                                <li class="page-item <?php if($page == '1') { echo "active"; }?>"><a class="page-link" href="search-profile.php?page=1">1</a></li>
                                <?php
                                }
                                if($total_page >= 2)
                                {
                                ?>
                                <li class="page-item <?php if($page == '2') { echo "active"; }?>"><a class="page-link" href="search-profile.php?page=2">2</a></li>
                                <?php
                                }
                                if($total_page >= 3)
                                {
                                ?>
                                <li class="page-item <?php if($page == '3') { echo "active"; }?>"><a class="page-link" href="search-profile.php?page=3">3</a></li>
                                <?php
                                }
                                if($total_page >= 4)
                                {
                                ?>
                                <li class="page-item <?php if($page == '4') { echo "active"; }?>"><a class="page-link" href="search-profile.php?page=4">4</a></li>
                                <?php
                                }
                                if($total_page >= 5)
                                {
                                ?>
                                <li class="page-item <?php if($page == '5') { echo "active"; }?>"><a class="page-link" href="search-profile.php?page=5">5</a></li>
                                <?php
                                }
                                if($total_page > $page)
                                {
                                ?>
                                <li class="page-item"><a class="page-link" href="search-profile.php?page=<?php echo $page + 1; ?>">Next</a></li>
                                <?php
                                }
                                ?>
                            </ul>
