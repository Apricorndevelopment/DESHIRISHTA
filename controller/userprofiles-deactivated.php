...
// --- 2. MODIFIED FILTER LOGIC (STRICTLY DEACTIVATED) ---
$filter_doc = "";

// Start with the condition that Profile Status MUST be 2 (Deactivated)
$conditions = ["profilestatus = '2'"];

// Check Document Filter (We keep this so you can filter docs within deactivated profiles)
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <h2 class="content-header-title float-left mb-0">Deactivated User Profiles</h2>
    ...
    .row{
        ...
        <div class="content-body">
            ...
            <div class="row mb-2" >
                ...
                <!-- Highlighted Deactivated Card since this page is for Deactivated -->
                <div class="col-xl-2 col-md-4 col-sm-6 col-12">
                    <div class="card card-stat bg-light-deactive text-center" style="border: 2px solid #ff9f43;">
                        <div class="card-body">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-header border-bottom p-1">
                                <h4 class="card-title">Deactivated Profiles List</h4>
                                ...
                                <div class="d-flex align-items-center flex-wrap">
                                    ...
                                    <form method="GET" action="" class="form-inline mr-1">
                                        ...
                                        <?php if($filter_doc !== '') { ?>
                                            <a href="deactivated_profiles.php" class="btn btn-sm btn-outline-secondary">Clear</a>
                                        <?php } ?>
                                    </form>

                                    <a href="export-users.php?status=deactivated" class="btn btn-success btn-sm" target="_blank">
                            ...
                            <div class="table-responsive p-1">
                                <table class="table table-striped table-hover" id="dt"> 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php 
                                            // Since we filtered for 2, this will mostly be Deactivated
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu">
            ...
            <a class="dropdown-item text-success" href="userprofile-update.php?uid=<?php echo $row['userid']; ?>&status=1">
                <i data-feather="check" class="mr-50"></i> Approve (Reactivate)
            </a>
            <?php endif; ?>
            ...
            <!-- No Deactivate button here since already Deactivated -->
               ...
               onclick="return confirm('Are you sure to delete?');">
                <i data-feather="trash-2" class="mr-50"></i> Delete
                                    ...
                                    <?php
                                        ...
                                        echo "<tr><td colspan='9' class='text-center py-3'>No Deactivated Profiles found.</td></tr>";
                                    }
                                    ?>
                                    </tbody>
                                </table>
