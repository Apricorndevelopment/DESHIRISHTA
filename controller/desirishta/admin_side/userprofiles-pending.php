...
// (This section remains exactly the same to show the stats boxes)
...
// --- 2. MODIFIED FILTER LOGIC (STRICTLY PENDING) ---
$filter_doc = "";

// Start with the condition that Profile Status MUST be 0 (Pending)
$conditions = ["profilestatus = '0'"];

// Check Document Filter (We keep this so you can filter docs within pending profiles)
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <h2 class="content-header-title float-left mb-0">Pending User Profiles</h2>
    ...
    .row{
        ...
        <div class="content-body">
            ...
            <div class="row mb-2" >
                ...
                <!-- Highlighted Pending Card since this page is for Pending -->
                <div class="col-xl-2 col-md-4 col-sm-6 col-12">
                    <div class="card card-stat bg-light-pending text-center" style="border: 2px solid #ea5455;">
                        <div class="card-body">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-header border-bottom p-1">
                                <h4 class="card-title">Pending Profiles List</h4>
                                
                                <div class="d-flex align-items-center flex-wrap">
                                    <!-- Filter Form -->
                                    <form method="GET" action="" class="form-inline mr-1">
                                        
                                        <!-- REMOVED Profile Status Filter (Because this page is ONLY for Pending) -->
                                        ...
                                        <?php if($filter_doc !== '') { ?>
                                            <a href="pending-profiles.php" class="btn btn-sm btn-outline-secondary">Clear</a>
                                        <?php } ?>
                                    </form>

                                    <a href="export-users.php?status=pending" class="btn btn-success btn-sm" target="_blank">
                            ...
                            <div class="table-responsive p-1">
                                <table class="table table-striped table-hover" id="dt"> 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php 
                                            // Since we filtered for 0, this will mostly be Pending, but logic kept safe
               ...
               onclick="return confirm('Are you sure to delete?');">
                <i data-feather="trash-2" class="mr-50"></i> Delete
                                    ...
                                    <?php
                                        ...
                                        echo "<tr><td colspan='9' class='text-center py-3'>No Pending Profiles found.</td></tr>";
                                    }
                                    ?>
                                    </tbody>
                                </table>
