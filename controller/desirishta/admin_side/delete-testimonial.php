...
if(isset($_GET['id'])) {
    ...
    $sql_select = "SELECT user_image FROM tbl_testimonials WHERE id = '$id'";
    ...
    $sql_delete = "DELETE FROM tbl_testimonials WHERE id = '$id'";
    
    if (mysqli_query($con, $sql_delete)) {
        header("Location: view-testimonials.php?status=deleted");
        exit();
    } else {
