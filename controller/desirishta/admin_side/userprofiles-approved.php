...
// --- 2. MODIFIED FILTER LOGIC (STRICTLY APPROVED) ---
$filter_doc = "";

// Start with the condition that Profile Status MUST be 1 (Approved)
$conditions = ["profilestatus = '1'"];

// Check Document Filter (We keep this so you can filter docs within approved profiles)
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <h2 class="content-header-title float-left mb-0">Approved User Profiles</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                        <li class="breadcrumb-item active">Approved Users</li>
                    </ol>
                </div>
            </div>
        </div>
<style>
    .row{
        ...
        <div class="content-body">
            ...
            <div class="row mb-2" >
                ...
                <!-- Highlighted Approved Card since this page is for Approved -->
                <div class="col-xl-2 col-md-4 col-sm-6 col-12">
                    <div class="card card-stat bg-light-approved text-center" style="border: 2px solid #28c76f;">
                        <div class="card-body">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-header border-bottom p-1">
                                <h4 class="card-title">Approved Profiles List</h4>
                                ...
                                <div class="d-flex align-items-center flex-wrap">
                                    ...
                                    <form method="GET" action="" class="form-inline mr-1">
                                        ...
                                        <?php if($filter_doc !== '') { ?>
                                            <a href="approved_profiles.php" class="btn btn-sm btn-outline-secondary">Clear</a>
                                        <?php } ?>
                                    </form>

                                    <a href="export-users.php?status=approved" class="btn btn-success btn-sm" target="_blank">
                            ...
                            <div class="table-responsive p-1">
                                <table class="table table-striped table-hover" id="dt"> 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php 
                                            // Since we filtered for 1, this will mostly be Approved
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu">
            ...
            <!-- Removed "Approve Profile" option since these are already approved -->
               ...
               onclick="return confirm('Are you sure to delete?');">
                <i data-feather="trash-2" class="mr-50"></i> Delete
                                    ...
                                    <?php
                                        ...
                                        echo "<tr><td colspan='9' class='text-center py-3'>No Approved Profiles found.</td></tr>";
                                    }
                                    ?>
                                    </tbody>
                                </table>
