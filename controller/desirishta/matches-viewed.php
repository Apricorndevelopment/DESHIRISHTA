...
$sqlviewed = "select DISTINCT(visit) from viewvist_ids where view = '$userid' and delete_status != 'delete' and firstapprove = '1'";
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="short-all">
                            <div class="short-lhs">
                                Showing <b><?php echo $rowviewed; ?></b> profiles
                            </div>
                            <div class="short-rhs">
                                <ul>
                                    <li>
                        ...
                        <div class="all-list-sh">
                            <ul>
                                ...
                                $sqlinfo = "select distinct(visit) from viewvist_ids where view = '$userid' and delete_status != 'delete' and firstapprove = '1' order by id $sort limit $lower_limit,3";
                    ...
                    <div class="col-md-4">
                        <div class="page-nation">
                            <ul class="pagination pagination-sm">
                                <?php
                                $sqltotalentry = "select distinct(visit) from viewvist_ids where view = '$userid' and delete_status != 'delete' and firstapprove = '1'";
                                ...
                                {
                                ?>
                                <li class="page-item"><a class="page-link" href="matches-viewed.php?page=<?php echo $page - 1; ?>&sort=<?php echo $_GET['sort']; ?>">Previous</a></li>
                                <?php
                                }
                                if($total_page >= 1)
                                {
                                ?>
                                <li class="page-item <?php if($page == '1') { echo "active"; }?>"><a class="page-link" href="matches-viewed.php?page=1&sort=<?php echo $_GET['sort']; ?>">1</a></li>
                                <?php
                                }
                                if($total_page >= 2)
                                {
                                ?>
                                <li class="page-item <?php if($page == '2') { echo "active"; }?>"><a class="page-link" href="matches-viewed.php?page=2&sort=<?php echo $_GET['sort']; ?>">2</a></li>
                                <?php
                                }
                                if($total_page >= 3)
                                {
                                ?>
                                <li class="page-item <?php if($page == '3') { echo "active"; }?>"><a class="page-link" href="matches-viewed.php?page=3&sort=<?php echo $_GET['sort']; ?>">3</a></li>
                                <?php
                                }
                                if($total_page >= 4)
                                {
                                ?>
                                <li class="page-item <?php if($page == '4') { echo "active"; }?>"><a class="page-link" href="matches-viewed.php?page=4&sort=<?php echo $_GET['sort']; ?>">4</a></li>
                                <?php
                                }
                                if($total_page >= 5)
                                {
                                ?>
                                <li class="page-item <?php if($page == '5') { echo "active"; }?>"><a class="page-link" href="matches-viewed.php?page=5&sort=<?php echo $_GET['sort']; ?>">5</a></li>
                                <?php
                                }
                                if($total_page > $page)
                                {
                                ?>
                                <li class="page-item"><a class="page-link" href="matches-viewed.php?page=<?php echo $page + 1; ?>&sort=<?php echo $_GET['sort']; ?>">Next</a></li>
                                <?php
                                }
                                ?>
                            </ul>
