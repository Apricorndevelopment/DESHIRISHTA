...
// 5. Main Query (Fixed: Removed 'firstapprove')
// Note: This query fetches profiles who VIEWED the logged-in user (where view = $userid)
$sqlviewed = "select DISTINCT(visit) from viewvist_ids where view = '$userid' and delete_status != 'delete'";
                ...
                <div class="col-md-9">
                    ...
                    <div class="all-list-sh">
                        <ul>
                            ...
                            // FIX: Removed 'firstapprove'
                            $sqlinfo = "select distinct(visit) from viewvist_ids where view = '$userid' and delete_status != 'delete' order by id $sort_val limit $lower_limit,3";
                            ...
                            if(!$resultinfo) {
                                ...
                                if($countinfo != 0)
                                {
                                    ...
                                    {
                                        $profileid = $rowinfo['visit']; // Note: 'visit' column used here based on your query
                                            ...
                                            <div class="all-pro-box user-avil-onli" data-useravil="avilyes"
                                                ...
                                                <div class="pro-img">
                                                    <div class="slid-inn pr-bio-c wedd-rel-pro sliderarrow m-0">
                                                        <ul class="slider5">
                                                            <?php if(isset($rowphotoinfo['profilepic']) && $rowphotoinfo['profilepic'] != '') { ?>
                                                            <li>
                                                ...
                                                <div class="pro-detail">
                                                    ...
                                                    <div class="pro-info-status mobile mb-2">
                                                        <?php if(isset($rowregistration['verificationinfo']) && $rowregistration['verificationinfo'] == 'Done') { ?>
                ...
                <div class="col-md-4">
                    <div class="page-nation">
                        <ul class="pagination pagination-sm" style="justify-content: center;">
                            <?php
                            // FIX: Removed 'firstapprove'
                            $sqltotalentry = "select distinct(visit) from viewvist_ids where view = '$userid' and delete_status != 'delete'";
                            ...
                            if($resulttotalentry) {
                                ...
                                if($page >= 2) {
                                ?>
                                <li class="page-item"><a class="page-link" href="matches-viewed.php?page=<?php echo $page - 1; ?>&sort=<?php echo $sort_url; ?>">Previous</a></li>
                                <?php }
                                
                                for($i = 1; $i <= $total_page; $i++) {
                                    if($i <= 5) {
                                    ?>
                                    <li class="page-item <?php if($page == $i) { echo "active"; }?>"><a class="page-link" href="matches-viewed.php?page=<?php echo $i; ?>&sort=<?php echo $sort_url; ?>"><?php echo $i; ?></a></li>
                                    <?php
                                    }
                                }
                                ...
                                if($total_page > $page) {
                                ?>
                                <li class="page-item"><a class="page-link" href="matches-viewed.php?page=<?php echo $page + 1; ?>&sort=<?php echo $sort_url; ?>">Next</a></li>
                                <?php
                                }
                            }
                            ?>
