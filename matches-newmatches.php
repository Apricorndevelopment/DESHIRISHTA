                    ...
                    <div class="col-md-4">
                        <div class="page-nation">
                            <ul class="pagination pagination-sm">
                                ...
                                {
                                ?>
                                <li class="page-item"><a class="page-link" href="matches-newmatches.php?page=<?php echo $page - 1; ?>&sort=<?php echo $_GET['sort']; ?>">Previous</a></li>
                                <?php
                                }
                                if($total_page >= 1)
                                {
                                ?>
                                <li class="page-item <?php if($page == '1' || $page == '') { echo "active"; }?>"><a class="page-link" href="matches-newmatches.php?page=1&sort=<?php echo $_GET['sort']; ?>">1</a></li>
                                <?php
                                }
                                if($total_page >= 2)
                                {
                                ?>
                                <li class="page-item <?php if($page == '2') { echo "active"; }?>"><a class="page-link" href="matches-newmatches.php?page=2&sort=<?php echo $_GET['sort']; ?>">2</a></li>
                                <?php
                                }
                                if($total_page >= 3)
                                {
                                ?>
                                <li class="page-item <?php if($page == '3') { echo "active"; }?>"><a class="page-link" href="matches-newmatches.php?page=3&sort=<?php echo $_GET['sort']; ?>">3</a></li>
                                <?php
                                }
                                if($total_page >= 4)
                                {
                                ?>
                                <li class="page-item <?php if($page == '4') { echo "active"; }?>"><a class="page-link" href="matches-newmatches.php?page=4&sort=<?php echo $_GET['sort']; ?>">4</a></li>
                                <?php
                                }
                                if($total_page >= 5)
                                {
                                ?>
                                <li class="page-item <?php if($page == '5') { echo "active"; }?>"><a class="page-link" href="matches-newmatches.php?page=5&sort=<?php echo $_GET['sort']; ?>">5</a></li>
                                <?php
                                }
                                if($total_page > 1)
                                {
                                ?>
                                <li class="page-item"><a class="page-link" href="matches-newmatches.php?page=<?php echo $page + 1; ?>&sort=<?php echo $_GET['sort']; ?>">Next</a></li>
                                <?php
                                }
                                ?>
                            </ul>
