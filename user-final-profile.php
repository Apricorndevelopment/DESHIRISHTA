                        ...
                        <div class="lhs">
                            ...
                            <div class="pr-bio-c pr-bio-conta">
                                ...
                                <div class="conborder">
                                    <ul class="coninfo">
                                        ...
                                        <li class="desktop"><span><i class="fa fa-envelope-o" aria-hidden="true"></i><b>Email</b><?php echo $rowcontactinfo['email']; ?>&nbsp;<?php if($rowregistration['emailverify'] == '1') { echo '<i class="fa fa-check text-success b-0" aria-hidden="true"></i>'; } ?></span></li>
                                        <li class="mobile"><span><i class="fa fa-envelope-o" aria-hidden="true"></i><b>Email</b><br><?php echo $rowcontactinfo['email']; ?>&nbsp;<?php if($rowregistration['emailverify'] == '1') { echo '<i class="fa fa-check text-success b-0" aria-hidden="true"></i>'; } ?></span></li>
                                        <?php
                                ...
                                <div class="lockscreen">
                                    ...
                                    <span><span class="pink" style="color:" id="removeblur">Click</span> to view contact details</span>
                                </div>
                            </div>
                            <!-- END PROFILE ABOUT -->
                            <!-- PROFILE ABOUT -->
                            <div class="pr-bio-c pr-bio-info">
                                ...
                                <ul>
                                    ...
                                    {
                                    ?>
                                    <li><b>State</b> <?php echo str_replace("_", " ", $rowlocationinfo['state']); ?></li>
                                    <?php
                                    }
                                    if($rowlocationinfo['city'] != '')
                                    {
                                    ?>
                                    <li><b>City</b> <?php echo $city11; ?></li>
                                    <?php
                                    }
                            ...
                            <div class="pr-bio-c pr-bio-info">
                                ...
                                <ul>
                                    ...
                                    {
                                    ?>
                                    <li><b>Profession</b> <?php echo str_replace("-", " ", $roweducationinfo['profession']); ?></li>
                                    <?php
                                    }
                                    if($roweducationinfo['designation'] != '')
                                    {
                                    ?>
                                    <li><b>Designation</b> <?php echo $roweducationinfo['designation']; ?></li>
                                    <?php
                                    }
                            ...
                            <div class="pr-bio-c pr-bio-info">
                                ...
                                <ul>
                                    ...
                                    if($rowfamilyinfo['familylocation'] == 'Same as my location')
                                    {
                                        if($rowlocationinfo['country'] != '')
                                        {
                                        ?>
                            ...
                            <div class="pr-bio-c pr-bio-info">
                                ...
                                <ul>
                                    ...
                                    {
                                    ?>
                                    <li><b>Caste</b> <?php if($rowpartnerinfo['castebar'] == 'yes') { echo "Caste No Bar"; } else { echo str_replace("//", ", ", $rowpartnerinfo['partnercaste']); } ?></li>
                                    <?php
                                    }
                                    ...
                                    {
                                    ?>
                                    <li><b>Working With</b> <?php echo str_replace("//", ", ", $rowpartnerinfo['partnerprofession']); ?></li>
                                    <?php
                                    }
                                    if($rowpartnerinfo['partnerdomain'] != '')
                                    {
                                    ?>
                                    <li><b>Profession</b> <?php echo str_replace("//", ", ", $rowpartnerinfo['partnerdomain']); ?></li>
                                    <?php
                                    }
