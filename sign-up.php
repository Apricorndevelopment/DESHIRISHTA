                                    ...
                                    <div id="mobileverify" style="display:none">
                                        ...
                                        <div class="form-login">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="iconbox">
                                                    <input type="hidden" class="form-control" id="phoneno" placeholder="Enter phone" name="phone" value="<?php echo  $_COOKIE['dr_phone']; ?>" onkeypress="return isNumberKey(event)" onkeyup="numberMobile(event);" readonly>
                                                    <input type="text" class="form-control leftspace" id="otp" placeholder="Enter OTP Code" name="otp" onkeypress="return isNumberKey(event)" onkeyup="numberMobile(event);">
                                            ...
                                            <button type="button" id="basicinfobtn" class="btn btn-primary mb-5">Verify Phone Number</button>
                                        </div>
                                    </div>
...
$('#basicinfobtn').click(function() {
    ...
    if(otp != '')
    {
        $.ajax({
            ...
            type: "POST",
            data: {phone_num : phoneno, otp_val : otp}
            }).done(function(data){
